...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                ...
                <tr>
                    ...
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                            ...
                            <Columns>
                                <asp:BoundField DataField="stdname" HeaderText="Batch" />
    ...
    <tr style="text-align: center">
        <td style="text-align: center">
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:AttSystemConnectionString %>" SelectCommand="SELECT [CID], [CourseName], [StdName] FROM [Course]"></asp:SqlDataSource>
        </td>
    </tr>
</table>
</asp:Content>
